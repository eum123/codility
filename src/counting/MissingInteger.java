...
public class MissingInteger {
	...
	public static void main(String[] args) {
		...
		System.out.println(t.solution(new int[]{1,5,3,4}));
		
		System.out.println(t.solution(new int[]{1,3,6,4,2}));
		
		System.out.println(t.solution(new int[]{1,3,6,4,1,2}));
		
		System.out.println(t.solution(new int[]{1,3}));
		
		System.out.println(t.solution(new int[]{-1,1,2,3}));
