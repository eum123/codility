 ...
 * Write a function:
 * 
 * int solution(int N); that, given a positive integer N, returns the length of
 * its longest binary gap. The function should return 0 if N doesn't contain a
 * binary gap.
 * 
...
public class BinaryGap {
	...
	public static void main(String[] args) {
		...
		System.out.println("max : " + b.solution(10));

		System.out.println("max : " + b.solution(1041));

		System.out.println("max : " + b.solution(2147483647));
	}
}
